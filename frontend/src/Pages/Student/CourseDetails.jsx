...
const CourseDetails = () => {
  ...
  // fetch the course data - for single course and its related details
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Bibek Acharya</span>
          </p>
                    ...
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1 ">
                          ...
                          />
                          <div className="flex items-center justify-between w-full text-gray-800 text-sm md:default">
        ...
        <div className="course-card z-10 custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:default  gap-4 pt-2 md:pt-4 text-gray-500">
